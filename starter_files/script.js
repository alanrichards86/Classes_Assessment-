...
class Car extends Factory {
  constructor (model, doors, color, enginetype, transmission, trim, wheeltrim, audio, seatstrim, moonroof, enginesize, navigation, backupcamera, warranty){
  super ({warranty});
  this.model = model;
  this.doors = doors;
  this.color = color;
...
let car = new Car('Mazda3', '4', 'red', 'Hybrid', 'Automatic', 'Touring', 'Base', 'Premium', 'Leather', true);
...
class Sport extends Car{
  constructor(model, trim, transmission, top, color, seatstrim, audio, wheeltrim, moonroof, enginetype, convertible, doors){
    super({});
    this.model = model;
    this.trim = trim;
    this.transmission = transmission;
...
// Truck should also have the following properties, default: backupcamera (true), audio (basic)
...
let truck = new Truck('Trail Blazer', 'blue', 8, true, 'Standard', true);
